...
2. Take the code above, place it into a click function like below (segmentation is removed & jQuery is the assumed JS framework in the below example):
...
3. Replace `.buy-now-class` with the appropriate button selector. `productId`,`productPrice`, `Transaction ID`, `Currency Code` will need to be mapped correctly as well.
